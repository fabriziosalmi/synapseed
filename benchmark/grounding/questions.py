...
QUESTIONS: list[GroundingQuestion] = [
    ...
    GroundingQuestion(
        ...
        ground_truth_answer="4.9.2",
        required_keywords=["4.9.2"],
    ...
    GroundingQuestion(
        ...
        ground_truth_answer="14 (13 lib + 1 bin)",
        required_keywords=["14"],
        required_files=["Cargo.toml"],
    ),
    GroundingQuestion(
        id="g04_tool_count",
        ...
        ground_truth_answer="21 tools in TOOL_NAMES constant",
        required_keywords=["21"],
    ...
    GroundingQuestion(
        ...
        required_files=["crates/shadow-check/src/plugin.rs"],
    ),
    # ── Cross-crate ──
    GroundingQuestion(
        id="g12_event_flow",
    ...
    GroundingQuestion(
        ...
        ground_truth_answer="Atomic (<3B), Molecular (3-30B), Galactic (>30B)",
        required_keywords=["Atomic", "Molecular", "Galactic"],
