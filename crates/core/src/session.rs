...
///
/// D31: All fields use `#[serde(default)]` so old session files survive
/// schema upgrades without silent data loss.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SessionState {
    /// Schema version — bump when adding/removing fields (D31).
...
/// Current schema version for `SessionState` (D31).
